...
CREATE TABLE `dusuario` (
  `usr_did` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `dusuario_ibfk_1` FOREIGN KEY (`usr_id`) REFERENCES `musuario` (`usr_id`) ON DELETE CASCADE ON UPDATE CASCADE
