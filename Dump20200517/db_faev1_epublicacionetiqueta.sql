...
--
-- Table structure for table `epublicacionetiqueta`
--

DROP TABLE IF EXISTS `epublicacionetiqueta`;
...
--
-- Dumping data for table `epublicacionetiqueta`
--

LOCK TABLES `epublicacionetiqueta` WRITE;
/*!40000 ALTER TABLE `epublicacionetiqueta` DISABLE KEYS */;
/*!40000 ALTER TABLE `epublicacionetiqueta` ENABLE KEYS */;
UNLOCK TABLES;
