...
--
-- Table structure for table `dhistorial`
--

DROP TABLE IF EXISTS `dhistorial`;
...
--
-- Dumping data for table `dhistorial`
--

LOCK TABLES `dhistorial` WRITE;
/*!40000 ALTER TABLE `dhistorial` DISABLE KEYS */;
/*!40000 ALTER TABLE `dhistorial` ENABLE KEYS */;
UNLOCK TABLES;
