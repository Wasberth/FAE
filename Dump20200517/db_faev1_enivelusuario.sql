...
CREATE TABLE `enivelusuario` (
  `niv_id` tinyint(3) unsigned NOT NULL,
  `usr_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`niv_id`,`usr_id`),
  KEY `usr_id` (`usr_id`),
  CONSTRAINT `enivelusuario_ibfk_1` FOREIGN KEY (`niv_id`) REFERENCES `cnivel` (`niv_id`),
  CONSTRAINT `enivelusuario_ibfk_2` FOREIGN KEY (`usr_id`) REFERENCES `musuario` (`usr_id`)
